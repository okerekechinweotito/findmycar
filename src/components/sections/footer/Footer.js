      ...
      <div className="container">
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-text">
              ...
              security Solutions and Vehicle Tracker Installation Services. We
              would help you secure and recover your vehicle in record time.
            </p>
          </div>
        ...
        <div className="footer-bottom" style={{ background: "#fff" }}>
          ...
          <p className="copyright">
            &copy; 2022 <a href="#">Okereke Chinweotito</a>. All Rights Reserved
          </p>
        </div>
      </div>
    </footer>
