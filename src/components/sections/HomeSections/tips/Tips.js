            ...
            <div className="tab-content">
              ...
              <div className="tab-pane fade show" id="tab2">
                <p>
                  ...
                  working in various business sectors, promoting innovation for
                  technology-based solutions and create a unique environment
                  where individuals, ideas, and solutions can thrive.
                </p>
                <div className="d-flex align-items-center mb-2">
                ...
                <p>
                  ...
                  individual to learn about Information Technology (IT) and also
                  a space for organising Events, Seminars, Conferences, Meetups,
                  Bootcamps e.t.c
                </p>
              </div>
              ...
              <div className="tab-pane fade show" id="tab3">
                <p>
                  ...
                  helping women access training and educational opportunities in
                  areas of Science Technology Engineering and Mathematics (STEM)
                  and Information Technology (IT) through meetups, workshops,
                  seminars, bootcamps and conferences. Aimed at building digital
                  literacy in women, expose them to available employment and
                  entrepreneurship opportunities within the technology space.
                </p>
                <div className="d-flex align-items-center mb-2">
                  <i className="bi bi-check2"></i>
